...
def save_tokenized_paragraphs():
    ...
    with open(PARAGRAPHS_FILES + '/tokenized_tolkien_paragraphs_numenor.pkl', "wb") as f:
        pkl.dump(tokenized_list, f)

def save_seed_texts():
    with open(PARAGRAPHS_FILES + '/tokenized_tolkien_paragraphs_numenor.pkl', 'rb') as f:
        data = pkl.load(f)
    ...
    with open(PARAGRAPHS_FILES + '/seed_text_paragraphs_numenor.pkl', "wb") as f:
