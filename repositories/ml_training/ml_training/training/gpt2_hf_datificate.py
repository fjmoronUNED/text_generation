...
from ml_training import GPT2_DATIFICATE, GPT2_HF_DATIFICATE
import os

class Gpt2TrainerDatificate:
    def __init__(self):

        self.train_path = HF_FILES + '/train.txt'
        self.test_path = HF_FILES + '/test.txt'
        self.model_files = GPT2_DATIFICATE
    ...
    def train_model(self):
        ...
        trainer.train()
        trainer.save_model(GPT2_HF_DATIFICATE)

trainer = Gpt2TrainerDatificate()
trainer.train_model()